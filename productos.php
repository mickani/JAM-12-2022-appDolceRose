...
<main class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card card-body">
                <form action="" name="frm_productos" id="frm_productos" method="POST">
                    ...
                    <div class="col-auto mt-2 text-center">
                        <button type="button" onclick="limpiar_frm_productos()"
                            class="btn btn-info btn-block">Limpiar</button>
                        <button type="button" onclick="guardar_producto()"
        ...
        <div class="col-12 col-md-8 my-4 my-md-0">
            <table class="table table-bordered table-secondary table-sm table-striped">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" onclick="editar_producto(<?php echo $row['id_producto']?>)"
                                class="btn btn-secondary">
                                <i class="fas fa-marker"></i>
                            </a>
                            <a type="button" onclick="eliminar_producto(<?php echo $row['id_producto']?>)"
