            ...
            <div class="card card-body">
                <form action="" name="frm_proveedores" id="frm_proveedores" method="POST">
                    ...
                    <div class="col-auto mt-2 text-center">
                        <button type="button" onclick="limpiar_frm_proveedores()"
                            class="btn btn-info btn-block">Limpiar</button>
                        <button type="button" onclick="guardar_proveedor()"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" onclick="editar_proveedor(<?php echo $row['id_proveedor']?>)"
                                class="btn btn-secondary">
                                <i class="fas fa-marker"></i>
                            </a>
                            <a type="button" onclick="eliminar_proveedor(<?php echo $row['id_proveedor']?>)"
